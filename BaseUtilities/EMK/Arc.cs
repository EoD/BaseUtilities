...
namespace EMK.Cartography
{
    ...
    /// </summary>
    [Serializable]
    public class Arc<TSystem>
    {
        private Node<TSystem> _StartNode, _EndNode;
        ...
        public Arc(Node<TSystem> Start, Node<TSystem> End)
        {
            StartNode = Start;
            EndNode = End;
            Weight = 1;
